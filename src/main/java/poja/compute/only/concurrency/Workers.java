package poja.compute.only.concurrency;

import static java.lang.Thread.currentThread;
import static java.util.concurrent.Executors.newVirtualThreadPerTaskExecutor;
import static poja.compute.only.concurrency.ThreadRenamer.getRandomSubThreadNamePrefixFrom;
import static poja.compute.only.concurrency.ThreadRenamer.renameThread;
