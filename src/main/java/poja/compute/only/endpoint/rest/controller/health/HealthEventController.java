...
import poja.compute.only.endpoint.event.EventProducer;
import poja.compute.only.endpoint.event.model.DurablyFallibleUuidCreated1;
import poja.compute.only.endpoint.event.model.DurablyFallibleUuidCreated2;
import poja.compute.only.endpoint.event.model.UuidCreated;
import poja.compute.only.repository.DummyUuidRepository;
